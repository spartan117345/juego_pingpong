...
while True:
    ...
    pygame.draw.rect(ventana,blanco,(500,100,600,20))
    pygame.draw.rect(ventana,blanco,(380,YY5,10,30))
    pygame.draw.rect(ventana,blanco,(400,YY6,10,20))
    pygame.draw.rect(ventana,blanco,(420,YY7,10,20))
    pygame.draw.rect(ventana,blanco,(440,YY8,10,20))    
    pygame.draw.rect(ventana,blanco,(600,YY9,10,20))   
    pygame.draw.rect(ventana,blanco,(100,YY10,10,20))   
    pygame.draw.rect(ventana,blanco,(100,YY11,10,20))   
    pygame.draw.rect(ventana,blanco,(100,YY12,10,20))  
    pygame.draw.line(ventana, blanco, (410,150),(410,450),4)
    ...
    texto = fuente_arial.render("version 1.8.0",3, gris_mas_oscuro)
