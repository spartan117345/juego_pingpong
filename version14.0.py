...
while True:
    ...
    ventana.blit(fondo_tienda, (0,YY6))
    ...
    if keys[pygame.K_RETURN] and tiempo3 == 0:
        tiempo2 = 20
        YY4 = -600
        XX5 = -300
        movimientoX = 50
    ...
    if keys[pygame.K_b] and tiempo5 == 0:
        YY6 = 0
        XX6 = 165
        XX7 = 570
        tiempo4 = 20
        
    if keys[pygame.K_n] and tiempo5 == 0:
        YY6 = -600
        XX6 = -100
        XX7 = 810
        tiempo4 = 0
        
    if keys[pygame.K_a] and tiempo4 >= 20:
        A1 += 1
    
    if keys[pygame.K_d] and tiempo4 >= 20:
        A1 -= 1
        
    if keys[pygame.K_RIGHT] and tiempo4 >= 20:
        B1 += 1
        
    if keys[pygame.K_LEFT] and tiempo4 >= 20:
        B1 -= 1
    ...
    texto = fuente_arial.render("version 1.14.0",3, gris_mas_oscuro)
    ...
    tienda1 = pygame.image.load(a)
    tienda1 = pygame.transform.scale(tienda1, (50,50))
    ventana.blit(tienda1, (XX6,230))
    
    tienda2 = pygame.image.load(b)
    tienda2 = pygame.transform.scale(tienda2,(50,50))
    ventana.blit(tienda2, (XX7, 230))
